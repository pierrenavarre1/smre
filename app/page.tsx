...
const areaImage = 'https://images.unsplash.com/photo-1784987608304-c3d715824382?auto=format&fit=crop&w=2200&q=90';
  ...
  return <>
    ...
    <section className="home-rural-strip">
      <div className="container home-rural-grid">
        <div className="home-rural-photo"><img src={areaImage} alt="Vibrant rural farm scene with a red barn, farmhouse, trees and open fields" /></div>
