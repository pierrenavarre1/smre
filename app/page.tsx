...
const areaImage = 'https://commons.wikimedia.org/wiki/Special:FilePath/StMarysKs.JPG';
  ...
  return <>
    ...
    <section className="home-rural-strip">
      <div className="container home-rural-grid">
        <div className="home-rural-photo"><img src={areaImage} alt="St. Marys, Kansas town street" /></div>
