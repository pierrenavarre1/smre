...
const areaImage = 'https://images.pexels.com/photos/33976208/pexels-photo-33976208/free-photo-of-aerial-view-of-modern-farmhouse-and-fields.jpeg?auto=compress&dpr=1&w=2200';
  ...
  return <>
    ...
    <section className="home-rural-strip">
      <div className="container home-rural-grid">
        <div className="home-rural-photo"><img src={areaImage} alt="Aerial view of a rural farmhouse surrounded by green fields" /></div>
