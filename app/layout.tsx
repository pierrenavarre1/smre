  ...
  return <html lang="en"><body>
    <header className="site-header">
      <div className="container nav">
        ...
        <nav className="nav-links" aria-label="Main navigation">
          ...
          <Link href="/listings">Listings</Link><Link href="/agents">Our Team</Link><Link href="/valuation">Home Value</Link><Link href="/about">About</Link><Link href="/contact" className="nav-cta">Contact</Link>
        </nav>
      </div>
    </header>
    <main>{children}</main>
    <footer className="footer">
      <div className="container footer-grid">
        <div className="footer-brand-block"><Link href="/" className="brand-logo footer-logo" aria-label="St. Mary’s Real Estate home"><BrandLogo className="logo-image" /></Link><p>512 W Bertrand Ave<br />St Marys, KS 66536<br /><a href="tel:7854652543" style={{color:'#fff'}}>(785) 465-2543</a></p></div>
